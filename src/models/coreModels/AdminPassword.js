...
AdminPasswordSchema.methods.generateHash = async function (saltOrPassword, password) {
...
AdminPasswordSchema.methods.addSession = function (sessionData) {
  this.activeSessions.push(sessionData);
  return this.save();
};

AdminPasswordSchema.methods.removeSession = function (tokenOrId) {
...
AdminPasswordSchema.methods.cleanupExpiredSessions = function () {
  const now = new Date();
...
AdminPasswordSchema.methods.blacklistToken = function (token, expiresAt) {
...
AdminPasswordSchema.methods.isTokenBlacklisted = function (token) {
