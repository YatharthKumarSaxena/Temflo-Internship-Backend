...
router.route('/leave-policy/:plantId').get(catchErrors(checkPermission('manage_leave'), requireReadAccess,
    leaveApi.adminLeaveController.getCompanyLeavePolicies))
router.route('/create-leave-balance/selected').post(checkPermission('manage_leave'), requireWriteAccess,
    catchErrors(leaveApi.adminLeaveController.applyLeavePolicyToSelectedEmployees))
router.route('/leave-balance/:employeeId').get(catchErrors(checkPermission('manage_leave'), requireReadAccess,
    leaveApi.employeeLeaveController.getLeaveBalancesByEmployeeId))
router.route('/policy/employee-list/:policyId').get(catchErrors(checkPermission('manage_leave'), requireReadAccess,
    leaveApi.adminLeaveController.getPolicyEmployees))
...
router.route('/leave-balance').get(catchErrors(checkPermission('manage_leave'), requireReadAccess,
    leaveApi.adminLeaveController.getCompanyLeaveBalances))
router.route('/leave-requests-summary/:plantId').get(catchErrors(checkPermission('manage_leave'), requireReadAccess,
    leaveApi.adminLeaveController.getLeaveRequests))
router.route('/leave-requests/:employeeId').get(catchErrors(checkPermission('manage_leave'), requireReadAccess, leaveApi.adminLeaveController.getLeaveRequestsByEmployee))
...
router.route('/create-leave-balance/:plantId/:policyId').get(catchErrors(checkPermission('manage_leave'), requireWriteAccess, leaveApi.adminLeaveController.createLeaveBalance))
router.route('/reset-leave-balance/:plantId/:policyId').get(catchErrors(checkPermission('manage_leave'), requireWriteAccess, leaveApi.adminLeaveController.resetLeaveBalance))
