...
router
  .route('/asset-type')
  .post(checkPermission('manage_asset'), requireWriteAccess, catchErrors(AssetApi.adminAssetController.createAssetType));
router
  .route('/asset-type')
  .get(checkPermission('manage_asset'), requireReadAccess, catchErrors(AssetApi.adminAssetController.getAssetType));
router
  .route('/asset-type/:id')
  .patch(checkPermission('manage_asset'), requireWriteAccess, catchErrors(AssetApi.adminAssetController.updateAssetType));
// router
//   .route('/asset-type/:id')
//   .delete(AdminOwner, catchErrors(AssetApi.adminAssetController.deleteAssetType));

// Asset CRUD routes (Admin only)
router.route('/add-asset').post(checkPermission('manage_asset'), requireWriteAccess, catchErrors(AssetApi.adminAssetController.addAsset));
router
  .route('/all-asset/:plantId')
  .get(checkPermission('manage_asset'), requireReadAccess, catchErrors(AssetApi.adminAssetController.getAssets));
router
  .route('/delete-asset/:id')
  .delete(checkPermission('manage_asset'), requireWriteAccess, catchErrors(AssetApi.adminAssetController.deleteAsset));
router
  .route('/update-asset/:id')
  .put(checkPermission('manage_asset'), requireWriteAccess, catchErrors(AssetApi.adminAssetController.updateAsset));
router
  .route('/add-asset-bulk/:plantId')
  .post(
    checkPermission('manage_asset'), requireWriteAccess,
...
router
  ...
  .get(checkPermission('manage_asset'), requireReadAccess, catchErrors(AssetApi.adminAssetController.getTransferRequests));
router
  .route('/transfer/:transferId/approve')
  .put(checkPermission('manage_asset'), requireWriteAccess, catchErrors(AssetApi.adminAssetController.approveAssetTransfer));
router
